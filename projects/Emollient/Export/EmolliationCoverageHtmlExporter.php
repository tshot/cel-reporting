...
/**
 * EmolliationCoverageHtmlExporter
 *
 * Renders the PI-presentation emolliation coverage table:
 *
 *   Site | Enrolled | Received Full Intervention (%) | Stopped (%)
 *
 * Two sections:
 *   Section 1 — Site summary table  (the PI presentation table)
 *   Section 2 — Per-baby detail     (sortable, for data review)
 *
 * External assets:
 *   CSS  /assets/css/emollient_eligible.css  (shared base)
 *   JS   /assets/js/emol_coverage.js         (sort + filter)
 */
class EmolliationCoverageHtmlExporter implements ExporterInterface
{
    private bool   $inline;
...
<title>Emolliation Coverage &mdash; Emollient</title>
<?= $cssTag ?>
<?= $covCssTag ?>
</head>
<body>
<div class="report-container">
  ...
  <div class="report-header">
    <div class="report-title">Emolliation Coverage &mdash; Emollient Trial</div>
    <div class="report-period"><?= htmlspecialchars($periodLabel) ?></div>
  </div>

  <!-- Section 1: PI Summary Table -->
...
<?php
// ── Compute grand totals before rendering rows ────────────────────
$gtBabies   = count($babies);
$gtDue      = 0;
$gtTotal    = 0;
$gtGiven    = 0;
$gtNotGiven = 0;
